...
const PostLoading: React.FC = () => {
  return (
    <div className="flex flex-col mx-3 w-[100%]">
      {/* Fake title section */}
      <div className="justify-left opacity-75 w-[100%] flex flex-row items-center gap-4 px-6 py-3 animate-pulse">
      ...
      <div className="flex min-h-[20%] w-[100%] flex-col justify-start gap-3 rounded-xl lg:rounded-2xl bg-slate-100 p-6 shadow-lg hover:shadow-xl">
        ...
        <div className="flex flex-row justify-between">
          ...
          <div className="rounded-md opacity-75 bg-red-400 px-8 py-3 shadow-md animate-pulse"></div>
        </div>
      </div>
